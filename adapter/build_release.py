...
def merge_single_file(output_dir='release'):
    ...
    final_content = f"""/**
 * CodingSnake.hpp - Snake Algorithm Competition Library (Single-File Edition)
 * 
 * A fully self-contained single-header library with bundled dependencies.
 * Approximate size: ~2MB (including httplib and nlohmann/json).
 * 
 * Usage:
 * 1. Put this file in the same directory as your main.cpp.
 * 2. Add #include \"CodingSnake.hpp\" in main.cpp.
 * 3. Build: g++ -std=c++11 main.cpp -o bot -lpthread
 * 
 * Project URL: https://github.com/yourusername/CodingSnake
 * 
 * @version 1.0.0
 * @date {current_date}
 * @auto-generated This file is generated by build_release.py
 */
...
// ============================================================================
// Third-party library: cpp-httplib
...
// ============================================================================
// CodingSnake core implementation
// ============================================================================
